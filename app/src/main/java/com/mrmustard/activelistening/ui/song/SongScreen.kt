...
fun SongScreen(
    ...
    onSavedSongArtworkRequested: (String) -> Unit,
            ...
            if (song == null) {
                LazyColumn(
                    ...
                    savedSessions(
                        ...
                        artworkBySongKey = state.savedSongArtwork,
                        onArtworkRequested = onSavedSongArtworkRequested,
                ...
                Column(modifier = Modifier.fillMaxSize()) {
                    ...
                    item {
                        ListeningSession(
                            ...
                            onTimelineBoundaryChanged = onTimelineBoundaryChanged,
